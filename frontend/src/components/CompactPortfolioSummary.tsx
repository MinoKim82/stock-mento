    ...
    <div className="p-4 space-y-4 overflow-auto h-full">
      ...
      {ownerSummary.length > 0 && (
        <div className="space-y-4">
          ...
          {ownerSummary.map(({ owner, accountTypes, total }) => (
              ...
              <div className="p-3 bg-gray-50 border-b border-gray-200">
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    <div className="text-sm font-bold text-blue-600">{formatCurrency(total.total_balance)}</div>
                    <div className={`text-xs ${getColorClass(total.total_gain_loss)}`}>
                      {formatCurrency(total.total_gain_loss)}
                    </div>
                  </div>
                </div>
              </div>
                    ...
                    <div className="grid grid-cols-2 gap-2 text-xs">
                      ...
                      <div>
                        ...
                        <div className={`font-bold ${getColorClass(accountType.total_gain_loss)}`}>
                          ...
                          <span className="ml-1">
                            ({formatPercentage(accountType.return_rate)})
                          </span>
                        </div>
                      </div>
                    </div>
